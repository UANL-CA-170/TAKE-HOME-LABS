...
void observador(){
  // Dinamica observador
  float f1 = Am11*XeR1 + Am12*XeR2 + Bm1*U + H1*(Y-(Cm1*XeR1 + Cm2*XeR2));     // Dinamica estado 1 observador
  float f2 = Am21*XeR1 + Am22*XeR2 + Bm2*U + H2*(Y-(Cm1*XeR1 + Cm2*XeR2));     // Dinamica estado 2 observador
...
void proc_entradas(){
  ...
  X1 = analogRead(pX1)*mX+bX;            // Lectura de salida de planta en pin pX1
